using SharedComponents.Utility.RP.Math.Exceptions;
using System;
...
namespace SharedComponents.Utility
{
    ...
    /// The Vec3 class is now immutable, property setters have been removed and mutable methods return a new Vec3
    ...
    /// Changed the Equals(object) method to use Equals(Vec3)
    ...
    /// Fixed an infinity issue in the Vec3.CompareTo method
    ...
    /// </Changes>
    /// <remarks>
    /// IComparable has been implemened on the Vec3 type however comparing two vectors has no meaning, we are comparing the magnitude of two vectors for convinience. 
        ...
        : IComparable, IComparable<Vec3>, IEquatable<Vec3>, IFormattable
    {
        ...
        /// <summary>
        /// Constructor for the Vec3 class accepting three doubles.
        /// </summary>
        /// <param name="x">The new x value for the Vec3</param>
        /// <param name="y">The new y value for the Vec3</param>
        /// <param name="z">The new z value for the Vec3</param>
        /// <implementation>
        /// Uses the mutator properties for the Vec3 components to allow verification of input (if implemented)
        /// This results in the need for pre-initialisation initialisation of the Vec3 components to 0 
        ...
        /// <summary>
        /// Constructor for the Vec3 class from an array.
        /// </summary>
        /// <param name="xyz">Array representing the new values for the Vec3</param>
        /// <implementation>
        ...
        {
            Quaternion pointQuat = new Quaternion((float)point.X, (float)point.Y, (float)point.Z, 0);
            Quaternion rotatedPointQuat = rotation * pointQuat * Quaternion.Conjugate(rotation);

            return new Vec3(rotatedPointQuat.X, rotatedPointQuat.Y, rotatedPointQuat.Z);
        }

        /// <summary>
        /// Constructor for the Vec3 class from another Vec3 object.
        /// </summary>
        /// <param name="v1">Vec3 representing the new values for the Vec3</param>
        /// <implementation>
        /// Copies values from Vec3 v1 to this vector, does not hold a reference to object v1 
        /// </implementation>
        public Vec3(Vec3 v1)
        {
            this.x = v1.X;
        ...
        public static implicit operator Vector3(Vec3 customType)
        {
            return new Vector3((float)customType.X, (float)customType.Y, (float)customType.Z);
        }
        ...
        /// <summary>
        /// Gets the magnitude (aka. length or absolute value) of the Vec3
        /// </summary>
        ...
        /// </summary>
        /// <param name="v1">Vec3 to be added to </param>
        /// <param name="v2">Vec3 to be added</param>
        /// <returns>Vec3 representing the sum of two Vectors</returns>
        ...
        /// </summary>
        /// <param name="v1">Vec3 to be subtracted from </param>
        /// <param name="v2">Vec3 to be subtracted</param>
        /// <returns>Vec3 representing the difference of two Vectors</returns>
        /// <Acknowledgement>This code is adapted from CSOpenGL - Lucas Viñas Livschitz </Acknowledgement>
        public static Vec3 operator -(Vec3 v1, Vec3 v2)
        {
            return new Vec3(
        ...
        /// </summary>
        /// <param name="v1">Vec3 to be multiplied </param>
        /// <param name="s2">Scalar value to be multiplied by </param>
        /// <returns>Vec3 representing the product of the vector and scalar</returns>
        /// <Acknowledgement>This code is adapted from CSOpenGL - Lucas Viñas Livschitz </Acknowledgement>
        ...
        /// <param name="v2">Vec3 to be multiplied by </param>
        /// <returns>Vec3 representing the product of the scalar and Vec3</returns>
        /// <Acknowledgement>This code is adapted from CSOpenGL - Lucas Viñas Livschitz </Acknowledgement>
        /// <Implementation>
        /// Using the commutative law 'scalar x vector'='vector x scalar'.
        /// Thus, this function calls 'operator*(Vec3 v1, double s2)'.
        ...
        /// </summary>
        /// <param name="v1">Vec3 to be divided </param>
        /// <param name="s2">Scalar value to be divided by </param>
        /// <returns>Vec3 representing the division of the vector and scalar</returns>
        /// <Acknowledgement>This code is adapted from CSOpenGL - Lucas Viñas Livschitz </Acknowledgement>
        public static Vec3 operator /(Vec3 v1, double s2)
        {
            return new Vec3(
        ...
        /// Invert the direction of the Vec3
        /// Make Vec3 negative (-vector)
        /// </summary>
        /// <param name="v1">Vec3 to be negated  </param>
        ...
        /// Make Vec3 positive (+vector).
        /// </summary>
        /// <param name="v1">Vec3 to be reinforced </param>
        ...
        /// </summary>
        /// <param name="v1">Vec3 to be compared </param>
        /// <param name="v2">Vec3 to be compared with</param>
        ...
        /// </summary>
        /// <param name="v1">Vec3 to be compared for equality </param>
        /// <param name="v2">Vec3 to be compared to </param>
        ...
        /// </summary>
        /// <param name="v1">Vec3 to be compared for in-equality </param>
        /// <param name="v2">Vec3 to be compared to </param>
        ...
        /// Determine the normal vector (Vec3 90° to the plane).
        /// </summary>
        /// <param name="v1">The vector to multiply</param>
        /// <param name="v2">The vector to multiply by</param>
        /// <returns>Vec3 representing the cross product of the two vectors</returns>
        /// <implementation>
        ...
        /// <see cref="CrossProduct(Vec3, Vec3)"/>
        /// </implementation>
        ...
        /// <implementation>
        /// Mixed products are non commutable
        /// <see cref="MixedProduct(Vec3, Vec3, Vec3)"/>
        /// Uses MixedProduct(Vec3, Vec3, Vec3) to avoid code duplication
        /// </implementation>
        ...
        public static double UnitProjection(Vec3 v1, Vec3 v2)
        {
            var u1 = v1.Magnitude != 0 ? v1.Normalize().DotProduct(v2.Normalize()) : 0;
            return u1;
        }
        ...
        {
            var dotProduct = UnitProjection(v1.Normalize(), v2.Normalize());
            var clampedDotProduct = Clamp(dotProduct, -1, 1);
            var angle = Math.Acos(clampedDotProduct);
            return angle;
        }
        ...
        /// Uses the private <see cref="NormalizeOrNaN(Vec3)"/> method to avoid code duplication.
        /// </implementation>
        ...
        /// <returns>The normalized vector.</returns>
        /// <implementation>
        /// Uses the static <see cref="Normalize(Vec3)"/> method to avoid code duplication."/> 
        /// </implementation>
        /// <exception cref="NormalizeVectorException">
        /// Thrown when the normalisation of a zero magnitude vector is attempted.
        /// </exception>
        ...
        /// </returns>
        /// <implementation>
        /// Uses the static <see cref="NormalizeOrDefault(Vec3)"/> method to avoid code duplication.
        /// </implementation>
        ...
        /// </summary>
        /// <param name="v1">The Vec3 to interpolate from (where control ==0)</param>
        /// <param name="v2">The Vec3 to interpolate to (where control ==1)</param>
        ...
        /// <implementation>
        /// <see cref="Interpolate(Vec3, Vec3, double, bool)"/>
        /// Uses the Interpolate(Vec3,Vec3,double,bool) method to avoid code duplication
        /// </implementation>
        /// <exception cref="System.ArgumentOutOfRangeException">
        ...
        /// Take an interpolated value from between two Vectors.
        /// </summary>
        /// <param name="other">The Vec3 to interpolate to (where control ==1)</param>
        /// <param name="control">The interpolated point between the two vectors to retrieve (fraction between 0 and 1)</param>
        /// <returns>The value at an arbitrary distance (interpolation) between two vectors</returns>
        /// <implementation>
        /// <see cref="Interpolate(Vec3, Vec3, double)"/>
        /// Overload for Interpolate method, finds an interpolated value between this Vec3 and another
        /// Uses the Interpolate(Vec3,Vec3,double) method to avoid code duplication
        /// </implementation>
        ...
        /// </summary>
        /// <param name="v1">The Vec3 to find the distance from </param>
        /// <param name="v2">The Vec3 to find the distance to </param>
        ...
        /// Apply Pythagoras theorem on two vectors.
        /// </summary>
        /// <param name="other">The Vec3 to find the distance to </param>
        /// <returns>The distance between two Vectors</returns>
        /// <implementation>
        /// <see cref="Distance(Vec3, Vec3)"/>
        /// Overload for Distance method, finds distance between this Vec3 and another
        /// Uses the Distance(Vec3,Vec3) method to avoid code duplication
        /// </implementation>
        ...
        public double DistanceToLine(Vec3 linePoint, Vec3 lineDirection)
        {
            Vec3 v = this - linePoint;
            Vec3 projection = v.DotProduct(lineDirection) * lineDirection;
            return v.Distance(projection);
        }
        ...
        /// </summary>
        /// <param name="v1">The Vec3 to discern the angle from </param>
        /// <param name="v2">The Vec3 to discern the angle to</param>
        ...
        /// </summary>
        /// <param name="other">The Vec3 to discern the angle to</param>
        /// <returns>The angle between two positional Vectors</returns>
        /// <implementation>
        /// <see cref="Angle(Vec3, Vec3)"/>
        /// Uses the Angle(Vec3,Vec3) method to avoid code duplication
        /// </implementation>
        ...
        /// </returns>
        /// <implementation>
        /// <see cref="Max(Vec3, Vec3)"/>
        /// Uses function Max(Vec3, Vec3) to avoid code duplication
        /// </implementation>
        /// <remarks>
        /// Comparing two vectors has no meaning, we are comparing the magnitude of two vectors for convinience. 
        ...
        /// </returns>
        /// <implementation>
        /// <see cref="Min(Vec3, Vec3)"/>
        /// Uses function Min(Vec3, Vec3) to avoid code duplication
        /// </implementation>
        /// <remarks>
        /// Comparing two vectors has no meaning, we are comparing the magnitude of two vectors for convinience. 
        ...
        /// </summary>
        /// <param name="v1">The Vec3 to be rotated</param>
        /// <param name="rad">The angle to rotate the Vec3 around in radians</param>
        /// <returns>Vec3 representing the rotation around the Y axis</returns>
        ...
        /// <returns>Vec3 representing the rotation around the Y axis</returns>
        /// <implementation>
        /// <see cref="Yaw(Vec3, Double)"/>
        /// Uses function Yaw(Vec3, double) to avoid code duplication
        /// </implementation>
        /// <remarks>This assumes a cartesian axis system of up:Y, right:X, depth:-Z</remarks>
        ...
        /// <param name="v1">The Vec3 to be rotated</param>
        /// <param name="rad">The angle to rotate the Vec3 around in radians</param>
        /// <returns>Vec3 representing the rotation around the X axis</returns>
        /// <remarks>This assumes a cartesian axis system of up:Y, right:X, depth:-Z</remarks>
        ...
        /// <param name="rad">The angle to rotate the Vec3 around in radians</param>
        /// <returns>Vec3 representing the rotation around the X axis</returns>
        /// <see cref="Pitch(Vec3, Double)"/>
        /// <implementation>
        /// Uses function Pitch(Vec3, double) to avoid code duplication
        /// </implementation>
        /// <remarks>This assumes a cartesian axis system of up:Y, right:X, depth:-Z</remarks>
        ...
        /// <param name="v1">The Vec3 to be rotated</param>
        /// <param name="rad">The angle to rotate the Vec3 around in radians</param>
        /// <returns>Vec3 representing the rotation around the Z axis</returns>
        /// <remarks>This assumes a cartesian axis system of up:Y, right:X, depth:-Z</remarks>
        ...
        /// <returns>Vec3 representing the rotation around the Z axis</returns>
        /// <implementation>
        /// <see cref="Roll(Vec3, Double)"/>
        /// Uses function Roll(Vec3, double) to avoid code duplication
        /// </implementation>
        /// <remarks>This assumes a cartesian axis system of up:Y, right:X, depth:-Z</remarks>
        ...
        /// </summary>
        /// <returns>A Vec3 representing the absolute values of the vector</returns>
        /// <implementation>
        ...
        /// <returns>The sum of the Vectors X, Y and Z components</returns>
        /// <implementation>
        /// <see cref="SumComponents(Vec3)"/>
        /// The Components.SumComponents(Vec3) function has been used to prevent code duplication
        /// </implementation>
        ...
        /// <returns>The sum of the Vectors X^2, Y^2 and Z^2 components</returns>
        /// <implementation>
        /// <see cref="SumComponentSqrs(Vec3)"/>
        /// The Components.SumComponentSqrs(Vec3) function has been used to prevent code duplication
        /// </implementation>
        ...
        /// <returns>The multiplied Vec3</returns>
        /// <implementation>
        /// <see cref="PowComponents(Vec3, Double)"/>
        /// The Components.PowComponents(Vec3, double) function has been used to prevent code duplication
        /// </implementation>
        ...
        /// <returns>The rooted Vec3</returns>
        ...
        /// <returns>The rooted Vec3</returns>
        /// <implementation>
        /// <see cref="SqrtComponents(Vec3)"/>
        /// The Components.SqrtComponents(Vec3) function has been used to prevent code duplication
        /// </implementation>
        ...
        /// <returns>The squared Vec3</returns>
        ...
        /// <implementation>
        /// <see cref="SqrtComponents(Vec3)"/>
        /// The Components.SqrComponents(Vec3) function has been used to prevent code duplication
        /// </implementation>
        ...
        {
            return new Vec3(Math.Round(this.X, digits), Math.Round(this.Y, digits), Math.Round(this.Z, digits));
        }
        ...
        {
            return new Vec3(Math.Round(this.X, mode), Math.Round(this.Y, mode), Math.Round(this.Z, mode));
        }
        ...
        {
            return new Vec3(Math.Round(this.X, digits, mode), Math.Round(this.Y, digits, mode), Math.Round(this.Z, digits, mode));
        }
        ...
        /// <implementation>
        /// Checks if the object argument is a Vec3 object 
        ...
        {
            // Check object other is a Vec3 object
            if (other is Vec3)
            {
                // Convert object to Vec3
                Vec3 otherVector = (Vec3)other;
        ...
        public bool Equals(object other, double tolerance)
        {
            if (other is Vec3)
            {
                return this.Equals((Vec3)other, tolerance);
            }
            return false;
        }
        ...
        /// Comparator.
        /// </summary>
        /// <param name="other">The other Vec3 to compare to</param>
        ...
        public int CompareTo(object other)
        {
            if (other is Vec3)
            {
                return this.CompareTo((Vec3)other);
            }

            // Error condition: other is not a Vec3 object
        ...
        public int CompareTo(object other, double tolerance)
        {
            if (other is Vec3)
            {
                return this.CompareTo((Vec3)other, tolerance);
            }
        ...
        /// <implementation>
        /// Uses the <see cref="IsUnitVector(Vec3)"/> method in the check to avoid code duplication
        /// </implementation>
        ...
        /// <implementation>
        /// Uses the <see cref="IsUnitVector(Vec3)"/> method to avoid code duplication
        /// </implementation>
        ...
        /// </summary>
        /// <param name="normal">
        /// The vector representing the face normal Vec3
        /// </param>
        ...
        /// <returns>Truth if the vector (as a normal) represents a back face</returns>
        /// <implementation>
        /// <see cref="Vec3.IsBackFace(Vec3, Vec3)"/> 
        /// Uses the isBackFace(Vec3, Vec3) function in the check to avoid code duplication
        /// </implementation>
        ...
        /// <implementation>
        /// Uses the <see cref="DotProduct(Vec3)"/> function in the check to avoid code duplication.
        /// Uses the <see cref="NormalizeOrDefault(Vec3)"/> function in the check to avoid code duplication and to include spcial cased of inifite values.
        ...
        /// <returns>Truth if the two vectors are perpendicular</returns>
        /// <implementation>
        /// Uses the <see cref="IsPerpendicualr(Vec3, Vec3)"/> function in the check to avoid code duplication.
        /// </implementation>
        ...
        /// <returns>Truth if the two vectors are perpendicular</returns>
        /// <implementation>
        /// Uses the <see cref="IsPerpendicualr(Vec3, Vec3, double)"/> function in the check to avoid code duplication.
        /// Of the three flavours of AlmostEquals that have been implemented the absolute value tolerance is the only one 
        /// that makes senses when comparing to 0. If we later implement relative and/or ulp tolerance, this method would not benefit from the overloads.
        /// </implementation>
        ...
        /// <summary>
        /// Exception message descriptive text, 
        /// used when attempting to compare a Vec3 to an object which is not a type of Vec3. 
        /// </summary>
